  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (aboutSection) {
        ...
        setShowFloatingButton(scrollPosition > aboutTop);
      }
    };
    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-800">
      ...
      {showFloatingButton && (
        <a
          ...
          className="fixed bottom-6 right-6 z-50 bg-[#227461] text-white p-4 rounded-full shadow-lg hover:bg-[#1a5a4a] transition-all duration-300 hover:scale-110 animate-slideUpFadeIn"
